...
public class WTLevyTestFLow extends BaseTest{
	...
	public void verifyWTLevyFlow(WiData data) throws Exception {
	    ...
	    wtlevyflow.executeWTLevyWorkflow(data);
