...
import com.mpro.ptax.fullWorkflow.STLevyFlow;
import com.mpro.ptax.fullWorkflow.WTLevyFlow;
...
public class STLevyTestFlow extends BaseTest{
	...
	public void verifySTLevyFlow(WiData data) throws Exception {
	    ...
	    stlevyflow.executeSTLevyWorkflow(data);
