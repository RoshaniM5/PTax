...
import com.mpro.ptax.fullWorkflow.STDeletionFlow;
...
public class STDeletionTestFlow extends BaseTest{
	...
	private STDeletionFlow stdeletionflow;
	...
	public void verifySTDeletionFlow(WiData data) throws Exception {
	    ...
	    stdeletionflow.executeSTDeletionWorkflow(data);   
