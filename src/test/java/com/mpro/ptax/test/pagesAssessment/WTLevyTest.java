...
public class WTLevyTest {
	    ...
	    private InwardFlowReAssessment exe2 = new InwardFlowReAssessment();
	    private WTLevy wtlevy = new WTLevy();
	    
	    @Test
	    public  void executeWTLevy(WiData data) throws Exception {
			...
			exe2.executeInwardReassement(data);
