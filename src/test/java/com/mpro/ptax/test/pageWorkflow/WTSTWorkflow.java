...
import com.mpro.ptax.pageobject.Workflow.WTSTLevy;
...
public class WTSTWorkflow extends BaseTest{
	...
	private Supdt supdt;
	  ...
	  @BeforeMethod(alwaysRun =true)
	    public void initFlow() {
	        ...
	        supdt= new Supdt();
	        wtstlevy= new WTSTLevy();
	        
	  }
	  
	  @Test(groups={"Sanity", "WTLevy"}, alwaysRun =true)
		public void verifySacInwardwithWTSTLevy() throws InterruptedException {
		    	...
		    	wtstlevy.verifyFormTypeForWTSTLevy();
		    	wtstlevy.verifyWTSTLevy();
