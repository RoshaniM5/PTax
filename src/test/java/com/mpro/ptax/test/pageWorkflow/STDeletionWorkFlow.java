...
import com.mpro.ptax.pageobject.Workflow.STDeletion;
...
public class STDeletionWorkFlow extends BaseTest{
	...
	private Supdt supdt;
	  ...
	  @BeforeMethod(alwaysRun =true)
	    public void initFlow() {
	        ...
	        supdt= new Supdt();
	        stdeletion= new STDeletion();
	        
	  }
	  
	  @Test(groups={"Sanity", "STDeletion"}, alwaysRun =true)
		public void verifySacInwardwithSTDeletion() throws InterruptedException {
		    	...
		    	stdeletion.verifyFormTypeForSTDeletion();
		    	stdeletion.verifySTDeletion();
