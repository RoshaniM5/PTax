...
public class WTLevy extends BasePage{
...
//	private static final By scroll_D						= By.xpath("(//section[@class='modal ng-scope'])[1]");
	...
	public void verifyFormTypeForWTLevy() {
	    ...
	    boolean inwardOpened = selectLatestInward();
	 		...
	 		selectFromDropdown(form_Type_Dropdown_Form_Type,"WT Levy");
	 		});
